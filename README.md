...
- [Zero Trust "RaMP" (Rapid Modernization Plan)](https://learn.microsoft.com/en-us/security/zero-trust/zero-trust-ramp-overview)
...
- [Azure Service Compliance Offers](https://aka.ms/AzureCompliance)
